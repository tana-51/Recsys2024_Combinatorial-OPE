...
@hydra.main(config_path="../conf",config_name="config_reward_std")
def main(cfg: DictConfig) -> None:
    ...
    reward_std_list = cfg.reward_std_list
    ...
    for reward_std in reward_std_list:
        ...
        for _ in tqdm(range(num_runs), desc=f"reward_std={reward_std}..."):
    ...
    result_df.to_csv("reward_std.csv")
